 ...
 *   bbitaly1_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: bbitaly1_field()
 *
 *   where bbitaly1 is the name of your sub-theme. For example, the
...
function bbitaly1_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  bbitaly1_preprocess_html($variables, $hook);
  bbitaly1_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_page(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // bbitaly1_preprocess_node_page() or bbitaly1_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function bbitaly1_preprocess_block(&$variables, $hook) {
...
function bbitaly_preprocess_page(&$vars) {
