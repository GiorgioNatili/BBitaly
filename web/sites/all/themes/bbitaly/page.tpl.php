...
?>
  ...
  <div class="header-align">
	  ...
	  <li class="Selectlang">
      <a id="lang-menu-item" href="#">select language<span id="lang-baloon"><img id="selected-flag" class="flag" src="../images/flag_it.jpg"/></span></a>
      </li>
...
<div id="copyright">
                        <section>
                            ...
                            Tutti i diritti riservati./<a href="">web agency napoli</a>
                        </section>
                    </div>
					<div id="social">
				</div>
