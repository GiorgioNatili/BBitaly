...
import it.adsolut.bbitaly.Request.Validator.NotDuplicatedOwnerEmail;
 ...
 * @author marcello
 */
public class OwnerInsertRequest extends SignedRequest {
    ...
    @NotNull(message=Code.Sintax.REQUEST_NOT_VALID)
    @NotEmpty(message=Code.Sintax.REQUEST_NOT_VALID)
    @NotDuplicatedOwnerEmail(message=Code.Owner.ALREADY_EXIST)
